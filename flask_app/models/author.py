...
class Author:
    ...
    def get_by_id(cls,data):
        query = "SELECT * FROM authors LEFT JOIN favorites ON authors.id = favorites.author_id LEFT JOIN books ON books.id = favorite.book_id WHERE authors.id = %(id)s;"
        results = connectToMySQL('books').query_db(query,db)
